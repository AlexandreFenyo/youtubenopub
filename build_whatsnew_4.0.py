...
FR = """Nouveautés de la version 4.0
...
ES = """Novedades de la versión 4.0
...
HU = """Újdonságok az 4.0-as verzióban
...
EL = """Τι νέο υπάρχει στην έκδοση 4.0
...
MR = """आवृत्ती 4.0 मध्ये नवीन काय आहे
...
VI = """Có gì mới trong phiên bản 4.0
...
MS = """Apa yang baharu dalam versi 4.0
...
with open("appstore-4.0-whatsnew.json", "w", encoding="utf-8") as fh:
    json.dump(doc, fh, ensure_ascii=False, indent=2)
    fh.write("\n")
print("Wrote appstore-4.0-whatsnew.json")
